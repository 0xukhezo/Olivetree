...
export default function Next() {
  return (
    <div className="double-color w-full h-[440px] flex items-center justify-center px-[20px] sm:px-[30px] md:px-[50px] lg:px-[100px] xl:px-[152px] text-center">
      <div className="bg-neutral2 w-screen h-[440px] px-[20px] md:px-[40px] py-[32px] hiddenShowRotate">
        <div className="xl:mt-[106px] mt-[56px]">
          ...
          <p className="max-w-[286px] sm:max-w-[386px] md:max-w-[486px] lg:max-w-[506px] mx-auto my-[16px] text-neutral6">
